...
#define NUM_LEDS 582
/***************SHEP*********************
/*#define BRIGHTNESS 250; */ /*DELETE THIS
****************SHEP*********************/
#define LED_TYPE    WS2812
#define COLOR_ORDER GRB

/***************SHEP*****************/
#define MAX_BRIGHTNESS 250     // Thats full on, watch the power! 
/*SHEP: Yeah set that to like 250 or something */
#define MIN_BRIGHTNESS 0       // set to a minimum of 25% 
/*SHEP: Set to zero to turn off, idk why 25%, but if following that comment it would be 32*/
/***************SHEP**********************/
